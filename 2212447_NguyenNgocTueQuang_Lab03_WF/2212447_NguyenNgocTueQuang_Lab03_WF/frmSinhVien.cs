...
namespace _2212447_NguyenNgocTueQuang_Lab03_WF
{
    ...
    SinhVien).MaSo.CompareTo(obj1.ToString());
        ...
        private void btnBrowse_Click(object sender, EventArgs e)
        {
            using (OpenFileDialog openFileDialog = new OpenFileDialog())
            {
                ...
                {
                    // Đặt hình ảnh của PictureBox thành hình ảnh từ tệp đã chọn
                   // btnBrowse.Image = System.Drawing.Image.FromFile(openFileDialog.FileName);
